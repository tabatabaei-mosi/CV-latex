...
\section{\bluesection{Research Experience and Projects}}
	...
	\resumeItemListStart
	\resumeItem{Collected and pre-processed over 300 EOR samples for training the model.}
	...
	\resumeItem{Developed and implemented a Quality Map to enhance accuracy and efficiency in well placement optimization.}
...
\section{\bluesection{Relevant Course}}
	\begin{multicols}{3}
		\begin{itemize}[itemsep=-1pt, parsep=4pt]
			...
			\item Reservoirs Simulation (4/4)
			\item Application of Mathematics in PetroleumEngineering (4/4) 
		\end{itemize}
	\end{multicols}
%	\vspace*{2.0\multicolsep}
...
%\section{\bluesection{References}}
%\begin{itemize}
%	\item \textbf{Dr. Behnam Sedaee, PhD}, Assistant Professor at UT (Email: \href{mailto:sedaee@ut.ac.ir}{sedaee@ut.ac.ir})
%	\item \textbf{Dr. Mohammadreza Rasaei, PhD}, Associate Professor at UT (Email: \href{mailto:mrasaei@ut.ac.ir}{mrasaei@ut.ac.ir})
%	\item \textbf{Dr. Behzad Rostami, PhD}, Associate Professor at UT (Email: \href{mailto:brostami@ut.ac.ir}{brostami@ut.ac.ir})
%	\item \textbf{Dr. Mozhdeh Sajjadi, PhD}, Assistant Professor at UT (Email: \href{mailto:sajjadi.mozhdeh@ut.ac.ir}{sajjadi.mozhdeh@ut.ac.ir}) 
%
%\end{itemize}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
			...
			\textbf{English}{: Fluent (TOEFL iBT is booked and will be taken on 14\textsuperscript{th} Oct.)} \\
	}}
\end{itemize}
\vspace{-16pt}
